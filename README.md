...
- **Production ecommerce + CI/CD proof:** RSCollection at `https://rscollection.online/`, with storefront, protected admin dashboard, PostgreSQL-backed products/orders/content, Docker Compose + Caddy HTTPS on AWS EC2, GitHub Actions CI, and CD through GitHub OIDC + AWS SSM. Source: `https://github.com/hevarrwandzi/rscollection`
